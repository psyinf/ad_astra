...
// configuration step. It creates a namespace called `ad_astra`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ad_astra::cmake::project_name, ad_astra::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", ad_astra::cmake::project_version);
      return EXIT_SUCCESS;
    }
